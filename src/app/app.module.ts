...
import { AppComponent } from './app.component';
import { ResInterceptInterceptor } from './services/interceptors/res-intercept.interceptor';
...
@NgModule({
    ...
    providers: [
        DatePipe,
        {
            provide: HTTP_INTERCEPTORS, useClass: ReqInterceptInterceptor,
            multi: true
        },
        {
            provide: HTTP_INTERCEPTORS, useClass: ResInterceptInterceptor,
            multi: true
        }
    ],
